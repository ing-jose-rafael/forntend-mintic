...
export const CitaCrear = () => {
  ...
  let { codDoctor, dobleEnlace, objeto } = useFormulario<Cita>(new Cita(codUsuario, usuarioVacio, usuarioVacio, fechaVacia, 1));

  // Obtener los médicos para mostrar en el combo
  const obtenerMedicos = async () => {
    // const urlMedicos = ApiBack.USUARIOS_OBTENER + "/63682c4240f3cbc1cb481082";
    const urlMedicos = ApiBack.USUARIOS_DOCTRS;
    // const urlMedicos = '/api/usuario';
                  ...
                  <div className="col-sm-4">
                    <DatePicker
                      ...
                      onChange={(fechaSeleccionada: any) => {
                        ...
                        objeto.fechaRegistro = fechaSeleccionada;
                      }}
                      isClearable
                      showTimeSelect
                      locale="es"
