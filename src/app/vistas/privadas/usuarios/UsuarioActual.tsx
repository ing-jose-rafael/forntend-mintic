...
export const UsuarioActual = () => {
  ...
  let { nombreUsuario, correoUsuario, estadoUsuario, nombreImagenUsuario, avatar, codPerfil, dobleEnlace, objeto,
  ...
  const obtenerUnUsuario = async () => {
    ...
    if (usuRecibido) {
      ...
      objeto.avatar = usuRecibido.avatar;
  ...
  const enviarFormulario = async (fh: formaHtml) => {
    ...
    if (formulario.checkValidity() === false) {
      ...
      objeto.avatar = avatarBase64;

      const urlActualizar = ApiBack.USUARIOS_ACTUALIZAR + "/" + codigo;
      const objetoActualizar = new Usuario( objeto._id, objeto.nombreUsuario, objeto.cedulaUsuario, objeto.correoUsuario, "", new Date(), objeto.estadoUsuario,
        nombreImagenUsuario !== "" ? nombreImagenUsuario : nombreimagenTempo, objeto.avatar, objeto.codPerfil );
